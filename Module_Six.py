# Grafton Brown - Module Six Milestone

rooms = {  # Dict provided with Exit room added for exiting the game
    'Great Hall': {'South': 'Bedroom', 'Exit': 'Exit'},
    'Bedroom': {'North': 'Great Hall', 'East': 'Cellar', 'Exit': 'Exit'},
    'Cellar': {'West': 'Bedroom', 'Exit': 'Exit'}
}
player = {'room': 'Bedroom'}  # Declare player dict with Key:value pairs and starting room

directions = {'North', 'South', 'East', 'West', 'Exit'}  # Inputs accepted while navigating rooms
print('Welcome to the Module Six Milestone Castle, you are in the Bedroom!')
